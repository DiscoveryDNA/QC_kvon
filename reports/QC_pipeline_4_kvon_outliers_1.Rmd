...
## You don't need brackets for faSomeRecords
## remove_list$bracket <- ">"
...
write.table(remove_list, "../data/output/list_of_seq_for_removal_6March2018.txt",sep = "\t", col.names = F, row.names = F, quote = F)
```